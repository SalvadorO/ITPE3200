...
namespace WebApp.BLL
{
    public interface IAdminBLL
    {
        ...
        List<AdminCustomer> searchCustomer(int id);
        List<AdminViewFlight> searchFlight(SearchFlight search);
        List<Employee> searchEmployee(String uname);
        List<AdminBooking> searchBooking(int id);
        ...
        bool EmpExists(EmployeeLogin inEmp);
    }
}
